...
**ARIF（accounts receivable and inventory financing）**  
ARIF is one kind of commercial loans based on asset-control. ARIF can accelerate the cycling speed of capital occupation from inventory, lowering the cost of capital occupation.   
...
###**Industry scale of supply chain finance**  
--------------------------------------------------------------------  
...
**How blockchain strengthen supply chain finance**  
-----------------------------------------------------------------
...
**2. Real proof of transaction based on deposit certificate**
...
**3.Credit dismantling based on shared ledger**  
...
**4.Contract execution based on smart contracts**  
...
Yang Shaohui, From bank's business model to do a research on supplychain finance[J]logistics technology, 2006, (10):179-182  
Songhua. Supply Chain Finance (Second Edition)
